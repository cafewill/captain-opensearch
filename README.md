...
| `simple-jobs-spring-maven-with-java21` | Spring Boot + Java 21 호환 + Vision AI MDC (`DemoScheduleService`) | 9023 | Maven |
| `simple-jobs-spring-maven-with-java25` | Spring Boot + Java 25 호환 + Vision AI MDC (`DemoScheduleService`) | 9024 | Maven |
...
`simple-jobs-spring-maven` 계열 앱의 `DemoScheduleService` Vision AI 파이프라인 잡이  
...
`simple-jobs-spring-maven` 계열 앱의 `DemoScheduleService`는 Vision AI 업무 프로세스를  
